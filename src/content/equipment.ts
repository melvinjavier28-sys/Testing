...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    products: [
      { slug: 'station-duo', name: 'Station Duo', type: 'Countertop POS', blurb: 'Dual-screen countertop POS for high-volume counters.', image: '/products/clover/station-duo.webp' },
      { slug: 'station-solo', name: 'Station Solo', type: 'Countertop POS', blurb: 'All-in-one countertop POS with a large merchant display.', image: '/products/clover/station-solo.jpg' },
      { slug: 'mini', name: 'Clover Mini', type: 'Compact POS', blurb: 'Space-saving countertop POS that does it all.', image: '/products/clover/mini.jpg' },
      { slug: 'flex', name: 'Clover Flex', type: 'Handheld POS', blurb: 'Handheld all-in-one for tableside and line-busting.', image: '/products/clover/flex.jpg' },
      { slug: 'compact', name: 'Clover Compact', type: 'Compact Terminal', blurb: 'Small-footprint smart terminal for tight counters.', image: '/products/clover/compact.png' },
      { slug: 'go', name: 'Clover Go', type: 'Mobile Reader', blurb: 'Contactless card reader for your phone or tablet.', image: '/products/clover/go.png' },
      { slug: 'kiosk', name: 'Clover Kiosk', type: 'Self-Service', blurb: 'Self-ordering kiosk for quick-service and retail.', image: '/products/clover/kiosk.png' },
    ],
  },
  {
    slug: 'pax',
    ...
    products: [
      ...
      { slug: 'aries8', name: 'Aries8', type: 'Smart PIN Pad', blurb: 'Interactive customer-facing smart PIN pad.', image: '/products/pax/aries8.jpg' },
      { slug: 'a77', name: 'A77', type: 'Mobile Terminal', blurb: 'Compact handheld terminal for field payments.', image: '/products/pax/a77.png' },
      { slug: 'im30', name: 'IM30', type: 'Unattended Terminal', blurb: 'Rugged unattended terminal for self-service kiosks.', image: '/products/pax/im30.png' },
    ],
  },
  {
    slug: 'ingenico',
